...
[![CI](https://github.com/PlatformStackPulse/tf-atom-wafv2-regex-pattern-set-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-wafv2-regex-pattern-set-aws/actions/workflows/ci.yml)
[![Release](https://github.com/PlatformStackPulse/tf-atom-wafv2-regex-pattern-set-aws/actions/workflows/auto-release.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-wafv2-regex-pattern-set-aws/actions/workflows/auto-release.yml)
[![CodeQL](https://github.com/PlatformStackPulse/tf-atom-wafv2-regex-pattern-set-aws/actions/workflows/codeql.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-wafv2-regex-pattern-set-aws/actions/workflows/codeql.yml)
![Terraform](https://img.shields.io/badge/terraform-%3E%3D1.6.0-blueviolet)
[![Latest Release](https://img.shields.io/github/v/release/PlatformStackPulse/tf-atom-wafv2-regex-pattern-set-aws)](https://github.com/PlatformStackPulse/tf-atom-wafv2-regex-pattern-set-aws/releases)

---

## Purpose

Terraform atom module for a single AWS WAFv2 Regex Pattern Set resource. Manages a collection of regular expressions for use in WAF rule statements to match request components.
...
|------|-------------|------|---------|:--------:|
| <a name="input_regular_expressions"></a> [regular\_expressions](#input\_regular\_expressions) | List of regular expression strings for the pattern set. | `list(string)` | n/a | yes |
| <a name="input_scope"></a> [scope](#input\_scope) | Scope of the Regex Pattern Set. Valid values: REGIONAL, CLOUDFRONT. | `string` | n/a | yes |
...
| <a name="input_description"></a> [description](#input\_description) | Description of the regex pattern set. | `string` | `""` | no |
...
| <a name="output_regex_pattern_set_arn"></a> [regex\_pattern\_set\_arn](#output\_regex\_pattern\_set\_arn) | The ARN of the WAFv2 Regex Pattern Set. |
| <a name="output_regex_pattern_set_id"></a> [regex\_pattern\_set\_id](#output\_regex\_pattern\_set\_id) | The ID of the WAFv2 Regex Pattern Set. |
<!-- END_TF_DOCS -->
